  ...
  BaseCarbonTonneStorage
{
  ...
  function addToExternalWhiteList(address[] memory erc20Addr) public onlyOwner {
  ...
  /// @param erc20Addr accepts an array of contract addresses
  function addToInternalWhiteList(address[] memory erc20Addr) public onlyOwner {
    uint256 addrLen = erc20Addr.length;
  ...
  /// @param erc20Addr accepts an array of contract addresses
  function addToInternalBlackList(address[] memory erc20Addr) public onlyOwner {
    uint256 addrLen = erc20Addr.length;
    ...
    returns (bool)
  {
    ...
    (projectData, vintageData) = ToucanCarbonOffsets(erc20Addr).getAttributes();
